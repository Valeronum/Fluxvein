...
@Mod("fluxvein")
public class FluxveinMod {
	public static final Logger LOGGER = LogManager.getLogger(FluxveinMod.class);
	...
	public FluxveinMod() {
		...
		FluxveinModBlocks.REGISTRY.register(bus);

		FluxveinModItems.REGISTRY.register(bus);
